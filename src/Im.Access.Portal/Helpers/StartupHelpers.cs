...
using Im.Access.Portal.Configuration;
using Im.Access.Portal.Configuration.ApplicationParts;
using Im.Access.Portal.Configuration.Constants;
using Im.Access.Portal.Configuration.Interfaces;
using Im.Access.Portal.Helpers.Localization;
using Im.Access.Portal.Services;
...
namespace Im.Access.Portal.Helpers
{
