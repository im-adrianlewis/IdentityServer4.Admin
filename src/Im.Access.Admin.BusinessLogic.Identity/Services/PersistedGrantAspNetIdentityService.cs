...
using Im.Access.Admin.BusinessLogic.Identity.Dtos.Grant;
using Im.Access.Admin.BusinessLogic.Identity.Events.PersistedGrant;
using Im.Access.Admin.BusinessLogic.Identity.Mappers;
using Im.Access.Admin.BusinessLogic.Identity.Resources;
using Im.Access.Admin.BusinessLogic.Identity.Services.Interfaces;
using Im.Access.Admin.BusinessLogic.Shared.ExceptionHandling;
using Im.Access.EntityFramework.Identity.Repositories.Interfaces;

namespace Im.Access.Admin.BusinessLogic.Identity.Services
{
