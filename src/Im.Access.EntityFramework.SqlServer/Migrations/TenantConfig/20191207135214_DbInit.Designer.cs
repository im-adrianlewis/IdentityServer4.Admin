...
namespace Im.Access.EntityFramework.SqlServer.Migrations.TenantConfig
{
    ...
    [Migration("20191207135214_DbInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.ClaimType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.ExternalProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.PasswordPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.TenantConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.ClaimType", b =>
                {
                    b.HasOne("Im.Access.EntityFramework.Entities.TenantConfiguration", "TenantConfiguration")
                        .WithMany("ClaimTypes")
            ...
            modelBuilder.Entity("Im.Access.EntityFramework.Entities.PasswordPolicy", b =>
                {
                    b.HasOne("Im.Access.EntityFramework.Entities.TenantConfiguration", "TenantConfiguration")
                        ...
                        .HasForeignKey("Im.Access.EntityFramework.Entities.PasswordPolicy", "TenantConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
