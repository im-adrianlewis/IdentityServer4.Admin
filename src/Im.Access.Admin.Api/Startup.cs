...
using Im.Access.Admin.Api.Configuration.Authorization;
using Im.Access.Admin.Api.ExceptionHandling;
using Im.Access.Admin.Api.Helpers;
using Im.Access.Admin.Api.Mappers;
using Im.Access.Admin.Api.Resources;
...
namespace Im.Access.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContexts<AdminIdentityDbContext, IdentityServerConfigurationDbContext, IdentityServerPersistedGrantDbContext, AdminLogDbContext, AdminAuditLogDbContext, AdminTenantConfigDbContext>(Configuration);
