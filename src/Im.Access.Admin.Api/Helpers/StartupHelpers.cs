...
using Im.Access.Admin.Api.AuditLogging;
using Im.Access.Admin.Api.Configuration;
using Im.Access.Admin.Api.Configuration.ApplicationParts;
using Im.Access.Admin.Api.Configuration.Constants;
using Im.Access.Admin.Api.Helpers.Localization;
...
namespace Im.Access.Admin.Api.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void AddDbContexts<TIdentityDbContext, TConfigurationDbContext, TPersistedGrantDbContext,
            TLogDbContext, TAuditLoggingDbContext, TTenantConfigDbContext>(this IServiceCollection services, IConfiguration configuration)
