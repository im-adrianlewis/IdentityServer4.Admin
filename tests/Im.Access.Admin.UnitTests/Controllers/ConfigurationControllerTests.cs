...
using Im.Access.Admin.Controllers;
...
namespace Im.Access.Admin.UnitTests.Controllers
{
    public class ConfigurationControllerTests
    {
        ...
        public async Task GetClientClaim()
        {
            ...
            viewModel.ClientClaims[0].Should().BeEquivalentTo(clientClaimAdded,
                opt => opt.Excluding(x => x.Client).Excluding(x => x.ClientId));
        }
        ...
        public async Task GetClientSecret()
        {
            ...
            viewModel.ClientSecrets[0].Should().BeEquivalentTo(clientSecretAdded, opt => opt
        ...
        public async Task AddClientProperty()
        {
            ...
            clientProperty.Should().BeEquivalentTo(newClientProperty, opts => opts
        ...
        public async Task GetClientProperty()
        {
            ...
            viewModel.ClientProperties[0].Should().BeEquivalentTo(clientPropertyAdded, opt => opt
                .Excluding(x => x.Client)
                .Excluding(x => x.ClientId));
        }
